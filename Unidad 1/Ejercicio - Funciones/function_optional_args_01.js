...
function getPropertyNames(o, /* optional */ a) {
    a = a || [];                                 // If undefined, use a new array    Si a tiene valor, a será true sino será un array vacío
    for(var property in o) a.push(property); // La variable debería ser declarada con let ya que sólo se usa en el bucle
    return a;
}
